...
class FirstTest {
	...
	void test() throws NullPredictionException, SynchException {
		...
		Production production3 = new Production(E_, Arrays.asList(EmptyTerminalSymbol.getInstance()));
		...
		Production production6 = new Production(T_, Arrays.asList(EmptyTerminalSymbol.getInstance()));
